...
map(
    "n",
    "<enter>",
    ":lua require'firvish.buffers'.jump_to_buffer()<CR>",
...
map(
    "n",
    "fm",
    ':lua require"firvish.buffers".filter_buffers("modified")<CR>',
    { silent = true, buffer = bufnr }
)
...
map(
    "n",
    "fa",
    ':lua require"firvish.buffers".filter_buffers("args")<CR>',
    { silent = true, buffer = bufnr }
)
...
map(
    "n",
    "R",
    ':lua require"firvish.buffers".refresh_buffers()<CR>',
    { silent = true, buffer = bufnr }
)
